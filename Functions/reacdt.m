...
% Monoacylated
r1 = k(1) * y(1) * y(3) * Ao^2; % A -> B
r2 = k(2) * y(1) * y(3) * Ao^2; % A -> C
r5 = k(3) * y(1) * y(3) * Ao^2; % A -> E

% Diacylated
r4 = k(2) * y(1) * y(4) * Ao^2;   % B -> D
r8 = k(3) * y(1) * y(4) * Ao^2;   % B -> F
r3 = k(1) * y(1) * y(5) * Ao^2;   % C -> D
r7 = k(3) * y(1) * y(5) * Ao^2;   % C -> G
r6 = k(2) * y(1) * y(6) * Ao^2;   % E -> G
r9 = k(1) * y(1) * y(6) * Ao^2;   % E -> F

%triacyleret
r10 = k(3) * y(1) * y(7) * Ao^2;  % D -> H
r11 = k(2) * y(1) * y(8) * Ao^2;  % F -> H
r12 = k(1) * y(1) * y(9) * Ao^2;  % G -> H

%SC degredation (scaled)
rdeg = -kd * y(1) * Ao; %dCsdeg/dt in M/min, y(2) er [OH-], uskaleret, NB
