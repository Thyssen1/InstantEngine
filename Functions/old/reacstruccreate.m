...
reacstruc.model.kAref   = 1.6e5*10;    % 1.17e5;%13.6e3; %9.9e4, kref=sum(kiR), reference T
...
%% Solver options
reacstruc.solver.opts = odeset('initialstep',1e-9,'RelTol',1e-9);
...
reacstruc.parfit.LB = [0 0 0]';                  % Lower bounds
reacstruc.parfit.UB = [1e7 .1 .01]';  % Upper bounds
...
reacstruc.optim.LB = [2 10 5 5 10]';  % Lower bounds
reacstruc.optim.UB = [10 12 40 50 60]';   % Upper bounds
